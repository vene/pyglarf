...
def test_correct_nps():
    assert_equal(nps[0].head.print_flat(indices=False, pos=False, lemma=False,
                                        structure=False),
                 'My wife')
    assert_equal(nps[1].head.print_flat(indices=False, pos=False, lemma=False,
                                        structure=False),
                 'wife')
    assert_equal(nps[2].name[0].print_flat(indices=False, pos=False,
                                           lemma=False, structure=False),
                 'Mary')
