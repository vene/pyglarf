...
# This is a partial backport. It only includes the Tree class, and some
# methods that depend on other parts of NLTK are replaced by NotImplemented
# exceptions. This is only so pyglarf will be able to run without NLTK.

# All of the licences, copyrights, attributions and notices from NLTK apply,
# except for the functions that throw NotImplemented.
...
class Tree(list):
    ...
    def productions(self):
        raise NotImplemented('This function is not available without NLTK.')
